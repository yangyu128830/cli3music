<template>
  <div class="wrapper"
    ...
    <general-nav @returnPage="returnPage"
                 class="fixed nav-color">
      <span class="text">{{iTitle}}</span>
    </general-nav>
    <div :class="{coverFixed, position}"
      ...
      <div class="data"
           ...
           :style="{opacity}">
        <div class="user-img">
          <img src="http://p1.music.126.net/86ildkNdYbtpJZLyGGsOSg==/109951163982316131.jpg"
               alt />
        </div>
        <div class="user-info-content">
          <div class="user-info-left">
            ...
            <div class="age-level">
              <span class="age">
                <i class="userInfo"
                   :class="{userInfonv: gender === 2,userInfonan: gender === 1}"></i>
                {{ birthday | setAge }}后
              </span>
    ...
    <div class="container-bottom pd23"
         :style="{ marginTop: top}">
      <div class="home"
           v-show="active==='first'">
      ...
      <user-dynamic v-show="active==='second'"
                    :dataInfo="dataInfo"></user-dynamic>
    </div>
  </div>
</template>
